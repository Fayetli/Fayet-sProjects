...
const short int startUnSpeed = 100;//(SDL_DELAY), the lower the number, the higher the speed
...
const short int minInterval = 50;//min interval(max unspeed), the lower the number, the higher the speed
